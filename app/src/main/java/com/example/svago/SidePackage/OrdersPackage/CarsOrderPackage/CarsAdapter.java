...
import com.example.svago.OfferPackage.OfferAdapter;
...
public class CarsAdapter extends RecyclerView.Adapter<CarsAdapter.ViewHolder> {
    ...
    public CarsAdapter(Context context, List<Car> carList, com.example.svago.Models.SharedResponses.userData userData) {
